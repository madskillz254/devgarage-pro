...
@main.route("/reset_password", methods=['GET', 'POST'])      #enters email to request password reset
def reset_request():
...
@main.route("/reset_password/<token>", methods=['GET', 'POST'])   #actual place to reset password
